...
void stencil_fopn_p1_cg(PNSystem::Stencil::Context& ctx)
{
	...
	M_3(1, 1) = (fields.sigma_t->eval(domain.voxelToWorld(vd+V3d(0.5, 0.5, 0.5)))+
			-(fields.sigma_s->eval(domain.voxelToWorld(vd+V3d(0.5, 0.5, 0.5)))*fields.f_p->eval(1, 0, domain.voxelToWorld(vd+V3d(0.5, 0.5, 0.5)))));
	M_3(2, 2) = (fields.sigma_t->eval(domain.voxelToWorld(vd+V3d(0.5, 0.5, 0.5)))+
			-(fields.sigma_s->eval(domain.voxelToWorld(vd+V3d(0.5, 0.5, 0.5)))*fields.f_p->eval(1, 0, domain.voxelToWorld(vd+V3d(0.5, 0.5, 0.5)))));
	...
	b(1, 0) = fields.q->eval(1, -1, domain.voxelToWorld(vd+V3d(0.5, 0.5, 0.5)));
	b(2, 0) = fields.q->eval(1, 1, domain.voxelToWorld(vd+V3d(0.5, 0.5, 0.5)));
