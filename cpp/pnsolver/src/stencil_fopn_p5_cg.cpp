...
void stencil_fopn_p5_cg(PNSystem::VoxelSystem& sys,
					PNSystem::Fields& fields)
{
	...
	M_3(11, 11) = (fields.sigma_t->eval(sys.voxelToWorld(vd+V2d(0.5, 0.5)))+
			-(fields.sigma_s->eval(sys.voxelToWorld(vd+V2d(0.5, 0.5)))*fields.f_p->eval(4, 0, sys.voxelToWorld(vd+V2d(0.5, 0.5)))));
	M_3(12, 12) = (fields.sigma_t->eval(sys.voxelToWorld(vd+V2d(0.5, 0.5)))+
			-(fields.sigma_s->eval(sys.voxelToWorld(vd+V2d(0.5, 0.5)))*fields.f_p->eval(4, 0, sys.voxelToWorld(vd+V2d(0.5, 0.5)))));
	M_3(13, 13) = (fields.sigma_t->eval(sys.voxelToWorld(vd+V2d(0.5, 0.5)))+
			-(fields.sigma_s->eval(sys.voxelToWorld(vd+V2d(0.5, 0.5)))*fields.f_p->eval(4, 0, sys.voxelToWorld(vd+V2d(0.5, 0.5)))));
	M_3(14, 14) = (fields.sigma_t->eval(sys.voxelToWorld(vd+V2d(0.5, 0.5)))+
			-(fields.sigma_s->eval(sys.voxelToWorld(vd+V2d(0.5, 0.5)))*fields.f_p->eval(4, 0, sys.voxelToWorld(vd+V2d(0.5, 0.5)))));
	M_3(15, 15) = (fields.sigma_t->eval(sys.voxelToWorld(vd+V2d(0.5, 0.5)))+
			-(fields.sigma_s->eval(sys.voxelToWorld(vd+V2d(0.5, 0.5)))*fields.f_p->eval(5, 0, sys.voxelToWorld(vd+V2d(0.5, 0.5)))));
	M_3(16, 16) = (fields.sigma_t->eval(sys.voxelToWorld(vd+V2d(0.5, 0.5)))+
			-(fields.sigma_s->eval(sys.voxelToWorld(vd+V2d(0.5, 0.5)))*fields.f_p->eval(5, 0, sys.voxelToWorld(vd+V2d(0.5, 0.5)))));
	M_3(17, 17) = (fields.sigma_t->eval(sys.voxelToWorld(vd+V2d(0.5, 0.5)))+
			-(fields.sigma_s->eval(sys.voxelToWorld(vd+V2d(0.5, 0.5)))*fields.f_p->eval(5, 0, sys.voxelToWorld(vd+V2d(0.5, 0.5)))));
	M_3(18, 18) = (fields.sigma_t->eval(sys.voxelToWorld(vd+V2d(0.5, 0.5)))+
			-(fields.sigma_s->eval(sys.voxelToWorld(vd+V2d(0.5, 0.5)))*fields.f_p->eval(5, 0, sys.voxelToWorld(vd+V2d(0.5, 0.5)))));
	M_3(19, 19) = (fields.sigma_t->eval(sys.voxelToWorld(vd+V2d(0.5, 0.5)))+
			-(fields.sigma_s->eval(sys.voxelToWorld(vd+V2d(0.5, 0.5)))*fields.f_p->eval(5, 0, sys.voxelToWorld(vd+V2d(0.5, 0.5)))));
	M_3(20, 20) = (fields.sigma_t->eval(sys.voxelToWorld(vd+V2d(0.5, 0.5)))+
			-(fields.sigma_s->eval(sys.voxelToWorld(vd+V2d(0.5, 0.5)))*fields.f_p->eval(5, 0, sys.voxelToWorld(vd+V2d(0.5, 0.5)))));
	...
	b(11, 0) = fields.q->eval(4, -2, sys.voxelToWorld(vd+V2d(0.5, 0.5)));
	b(12, 0) = fields.q->eval(4, 0, sys.voxelToWorld(vd+V2d(0.5, 0.5)));
	b(13, 0) = fields.q->eval(4, 2, sys.voxelToWorld(vd+V2d(0.5, 0.5)));
	b(14, 0) = fields.q->eval(4, 4, sys.voxelToWorld(vd+V2d(0.5, 0.5)));
	b(15, 0) = fields.q->eval(5, -5, sys.voxelToWorld(vd+V2d(0.5, 0.5)));
	b(16, 0) = fields.q->eval(5, -3, sys.voxelToWorld(vd+V2d(0.5, 0.5)));
	b(17, 0) = fields.q->eval(5, -1, sys.voxelToWorld(vd+V2d(0.5, 0.5)));
	b(18, 0) = fields.q->eval(5, 1, sys.voxelToWorld(vd+V2d(0.5, 0.5)));
	b(19, 0) = fields.q->eval(5, 3, sys.voxelToWorld(vd+V2d(0.5, 0.5)));
	b(20, 0) = fields.q->eval(5, 5, sys.voxelToWorld(vd+V2d(0.5, 0.5)));
