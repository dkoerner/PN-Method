...
void stencil_fopn_p5_sg(PNSystem::Stencil::Context& ctx)
{
	...
	for( int i=0;i<8;++i )
	{
		...
		M_3(15, 15) = (fields.sigma_t->eval(domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))+
			-(fields.sigma_s->eval(domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))*fields.f_p->eval(3, 0, domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))));
		M_3(16, 16) = (fields.sigma_t->eval(domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))+
			-(fields.sigma_s->eval(domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))*fields.f_p->eval(4, 0, domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))));
		M_3(17, 17) = (fields.sigma_t->eval(domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))+
			-(fields.sigma_s->eval(domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))*fields.f_p->eval(4, 0, domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))));
		M_3(18, 18) = (fields.sigma_t->eval(domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))+
			-(fields.sigma_s->eval(domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))*fields.f_p->eval(4, 0, domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))));
		M_3(19, 19) = (fields.sigma_t->eval(domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))+
			-(fields.sigma_s->eval(domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))*fields.f_p->eval(4, 0, domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))));
		M_3(20, 20) = (fields.sigma_t->eval(domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))+
			-(fields.sigma_s->eval(domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))*fields.f_p->eval(4, 0, domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))));
		M_3(21, 21) = (fields.sigma_t->eval(domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))+
			-(fields.sigma_s->eval(domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))*fields.f_p->eval(4, 0, domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))));
		M_3(22, 22) = (fields.sigma_t->eval(domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))+
			-(fields.sigma_s->eval(domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))*fields.f_p->eval(4, 0, domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))));
		M_3(23, 23) = (fields.sigma_t->eval(domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))+
			-(fields.sigma_s->eval(domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))*fields.f_p->eval(4, 0, domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))));
		M_3(24, 24) = (fields.sigma_t->eval(domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))+
			-(fields.sigma_s->eval(domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))*fields.f_p->eval(4, 0, domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))));
		M_3(25, 25) = (fields.sigma_t->eval(domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))+
			-(fields.sigma_s->eval(domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))*fields.f_p->eval(5, 0, domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))));
		M_3(26, 26) = (fields.sigma_t->eval(domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))+
			-(fields.sigma_s->eval(domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))*fields.f_p->eval(5, 0, domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))));
		M_3(27, 27) = (fields.sigma_t->eval(domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))+
			-(fields.sigma_s->eval(domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))*fields.f_p->eval(5, 0, domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))));
		M_3(28, 28) = (fields.sigma_t->eval(domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))+
			-(fields.sigma_s->eval(domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))*fields.f_p->eval(5, 0, domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))));
		M_3(29, 29) = (fields.sigma_t->eval(domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))+
			-(fields.sigma_s->eval(domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))*fields.f_p->eval(5, 0, domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))));
		M_3(30, 30) = (fields.sigma_t->eval(domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))+
			-(fields.sigma_s->eval(domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))*fields.f_p->eval(5, 0, domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))));
		M_3(31, 31) = (fields.sigma_t->eval(domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))+
			-(fields.sigma_s->eval(domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))*fields.f_p->eval(5, 0, domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))));
		M_3(32, 32) = (fields.sigma_t->eval(domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))+
			-(fields.sigma_s->eval(domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))*fields.f_p->eval(5, 0, domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))));
		M_3(33, 33) = (fields.sigma_t->eval(domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))+
			-(fields.sigma_s->eval(domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))*fields.f_p->eval(5, 0, domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))));
		M_3(34, 34) = (fields.sigma_t->eval(domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))+
			-(fields.sigma_s->eval(domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))*fields.f_p->eval(5, 0, domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))));
		M_3(35, 35) = (fields.sigma_t->eval(domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))+
			-(fields.sigma_s->eval(domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))*fields.f_p->eval(5, 0, domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)))));
	...
	for( int i=0;i<8;++i )
	{
		...
		b(16, 0) = fields.q->eval(4, -4, domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)));
		b(17, 0) = fields.q->eval(4, -3, domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)));
		b(18, 0) = fields.q->eval(4, -2, domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)));
		b(19, 0) = fields.q->eval(4, -1, domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)));
		b(20, 0) = fields.q->eval(4, 0, domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)));
		b(21, 0) = fields.q->eval(4, 1, domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)));
		b(22, 0) = fields.q->eval(4, 2, domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)));
		b(23, 0) = fields.q->eval(4, 3, domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)));
		b(24, 0) = fields.q->eval(4, 4, domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)));
		b(25, 0) = fields.q->eval(5, -5, domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)));
		b(26, 0) = fields.q->eval(5, -4, domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)));
		b(27, 0) = fields.q->eval(5, -3, domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)));
		b(28, 0) = fields.q->eval(5, -2, domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)));
		b(29, 0) = fields.q->eval(5, -1, domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)));
		b(30, 0) = fields.q->eval(5, 0, domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)));
		b(31, 0) = fields.q->eval(5, 1, domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)));
		b(32, 0) = fields.q->eval(5, 2, domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)));
		b(33, 0) = fields.q->eval(5, 3, domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)));
		b(34, 0) = fields.q->eval(5, 4, domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)));
		b(35, 0) = fields.q->eval(5, 5, domain.voxelToWorld(vd+ctx.getVoxelSpaceOffsetFromGrid2(i)));
