...
void stencil_p5_3d_cg(PNSystem::Stencil::Context& ctx)
{
	...
	{
		double c = 0.0;
		c+=ctx.evalEmission(5, -4, 0, 0, 0)[color_channel];
		ctx.coeff_b( 26 ) += c;
	}
	// row=27 l=5 m=-3 --------------------------
	...
	{
		double c = 0.0;
		c+=ctx.evalEmission(5, -2, 0, 0, 0)[color_channel];
		ctx.coeff_b( 28 ) += c;
	}
	// row=29 l=5 m=-1 --------------------------
	...
	{
		double c = 0.0;
		c+=ctx.evalEmission(5, 0, 0, 0, 0)[color_channel];
		ctx.coeff_b( 30 ) += c;
	}
	// row=31 l=5 m=1 --------------------------
...
V3i stencil_p5_3d_cg_get_offset(int coeff)
{
	switch(coeff)
	{
		...
		case 25:return V3i(1, 1, 1);break;
		case 26:return V3i(1, 1, 1);break;
		case 27:return V3i(1, 1, 1);break;
		case 28:return V3i(1, 1, 1);break;
		case 29:return V3i(1, 1, 1);break;
		case 30:return V3i(1, 1, 1);break;
		case 31:return V3i(1, 1, 1);break;
		case 32:return V3i(1, 1, 1);break;
		case 33:return V3i(1, 1, 1);break;
		case 34:return V3i(1, 1, 1);break;
		case 35:return V3i(1, 1, 1);break;
		default:throw std::runtime_error("unexpected coefficient index");break;
	};
}
REGISTER_STENCIL(stencil_p5_3d_cg, 5, 36, 1)
