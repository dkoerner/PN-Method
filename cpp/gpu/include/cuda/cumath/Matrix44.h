...
namespace cumath
{
	...
	struct Matrix44
	{
		...
		HOST_DEVICE Matrix44( const T &_11, const T &_12, const T &_13, const T &_14,
		...
		HOST_DEVICE Matrix44( const Vec3<T> &right, const Vec3<T> &up, const Vec3<T> &forward, const Vec3<T> &translation = Vec3<T>((T)0.0) );
		template<typename S>
		HOST_DEVICE Matrix44( const Matrix44<S> &other );
		/*
		...
		*/
		HOST_DEVICE static Matrix44<T>                            TranslationMatrix( const Vec3<T> &translation );  ///< returns a matrix which defines a translation of the specified translation vector
		HOST_DEVICE static Matrix44<T>                    TranslationMatrix( const T &x, const T &y, const T &z );  ///< returns a matrix which defines a translation of the specified translation vector
		/*
		static Matrix44<T>                                       ScaleMatrix( const T &uniformScale );  ///< returns a matrix which defines a uniform scale
		*/
		HOST_DEVICE static Matrix44<T>                          ScaleMatrix( const T &x, const T &y, const T &z );  ///< returns a matrix which defines a non-uniform scale
		/*
		...
		*/
		HOST_DEVICE void                                                                           invert( void );
		HOST_DEVICE Matrix44<T>                                                             inverted( void )const;
		HOST_DEVICE Matrix44<T>                                                              inverse( void )const; // same as inverted (here for Imath compatibility)
		/*
		...
		*/
		HOST_DEVICE Matrix44<T>                                           getOrientation( void )const;
		//Matrix44<T>                                                  getNormalizedOrientation( void );
		/*
		Matrix44<T>                                                             getTransposed( void );
		...
		*/
		HOST_DEVICE Matrix44<T>                                          &translate( const Vec3<T> &translation ); ///< translates the current transform
		/*
		...
		*/
		HOST_DEVICE Matrix44<T>                                                        &scale( const Vec3<T> &s ); ///< scales the current transform non-uniformly
		/*
	...
	template<typename T>
	template<typename S>
	HOST_DEVICE Matrix44<T>::Matrix44( const Matrix44<S> &other )
	{
	...
	template<typename T>
	HOST_DEVICE Matrix44<T>::Matrix44()
	{
		_12=_13=_14=
		_21=_23=_24=
		_31=_32=_34=
	...
	template<typename T>
	HOST_DEVICE Matrix44<T>::Matrix44( const T &_11, const T &_12, const T &_13, const T &_14,
                          const T &_21, const T &_22, const T &_23, const T &_24,
                          const T &_31, const T &_32, const T &_33, const T &_34,
                          const T &_41, const T &_42, const T &_43, const T &_44 )
	{
	...
	template<typename T>
	HOST_DEVICE Matrix44<T>::Matrix44( const Vec3<T> &right, const Vec3<T> &up, const Vec3<T> &forward, const Vec3<T> &translation )
	{
	...
	*/
	...
	template<typename T>
	HOST_DEVICE Matrix44<T> Matrix44<T>::TranslationMatrix( const Vec3<T> &translation )
	{
		return Matrix44<T>( (T)1.0, (T)0.0, (T)0.0, (T)0.0,
			              (T)0.0, (T)1.0, (T)0.0, (T)0.0,
						  (T)0.0, (T)0.0, (T)1.0, (T)0.0,
	...
	// returns a matrix which defines a translation of the specified translation vector
	template<typename T>
	HOST_DEVICE Matrix44<T> Matrix44<T>::TranslationMatrix( const T &x, const T &y, const T &z )
	{
		return Matrix44<T>( (T)1.0, (T)0.0, (T)0.0, (T)0.0,
			              (T)0.0, (T)1.0, (T)0.0, (T)0.0,
						  (T)0.0, (T)0.0, (T)1.0, (T)0.0,
	...
	*/
	...
	template<typename T>
	HOST_DEVICE Matrix44<T> Matrix44<T>::ScaleMatrix( const T &x, const T &y, const T &z )
	{
	...
	*/
	template<typename T>
	HOST_DEVICE Matrix44<T> &Matrix44<T>::translate( const Vec3<T> &translation )
	{
	...
	*/
	...
	///< scales the current transform non-uniformly
	template<typename T>
	HOST_DEVICE Matrix44<T> & Matrix44<T>::scale( const Vec3<T> &s )
	{
	...
	*/
	...
	template<typename T>
	HOST_DEVICE inline T Det(	T &f_11, T &f_12, T &f_13,
	...
	template<typename T>
	HOST_DEVICE void Matrix44<T>::invert( void )
	{
	...
	template<typename T>
	HOST_DEVICE Matrix44<T> Matrix44<T>::inverted( void )const
	{
		Matrix44<T> m = *this;
		m.invert();
		return m;
	...
	template<typename T>
	HOST_DEVICE Matrix44<T> Matrix44<T>::inverse( void )const
	{
		Matrix44<T> m = *this;
		m.invert();
		return m;
	...
	*/
	template<typename T>
	HOST_DEVICE Matrix44<T> Matrix44<T>::getOrientation( void )const
	{
	...
	/*
	template<typename T>
	Matrix44<T> Matrix44<T>::getTransposed( void )
	{
	...
	template<typename T>
	Matrix44<T> Matrix44<T>::getNormalizedOrientation( void )
	{
