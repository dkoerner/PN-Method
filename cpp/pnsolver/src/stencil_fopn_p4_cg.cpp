...
void stencil_fopn_p4_cg(PNSystem::Stencil::Context& ctx)
{
	...
	M_3_real.row(6) = M_3_real_staggered[2].row(6);
	M_3_real.row(7) = M_3_real_staggered[2].row(7);
	M_3_real.row(8) = M_3_real_staggered[2].row(8);
	M_3_real.row(9) = M_3_real_staggered[2].row(9);
	M_3_real.row(10) = M_3_real_staggered[2].row(10);
	M_3_real.row(11) = M_3_real_staggered[2].row(11);
	M_3_real.row(12) = M_3_real_staggered[2].row(12);
	M_3_real.row(13) = M_3_real_staggered[2].row(13);
...
V3i stencil_fopn_p4_cg_get_offset(int coeff)
{
	switch(coeff)
	{
...
REGISTER_STENCIL(stencil_fopn_p4_cg, 4, 15, 1)
