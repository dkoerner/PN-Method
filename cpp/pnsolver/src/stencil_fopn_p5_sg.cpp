...
void stencil_fopn_p5_sg(PNSystem& sys,
					const V2i& voxel)
{
	V2i vi = voxel;
	...
	M_3(14, 14) = (fields.sigma_t->eval(domain.voxelToWorld(vd+V2d(0.5, 0.5)))+
			-(fields.sigma_s->eval(domain.voxelToWorld(vd+V2d(0.5, 0.5)))*fields.f_p->eval(4, 0, domain.voxelToWorld(vd+V2d(0.5, 0.5)))));
	M_3(15, 15) = (fields.sigma_t->eval(domain.voxelToWorld(vd+V2d(0.0, 0.5)))+
			-(fields.sigma_s->eval(domain.voxelToWorld(vd+V2d(0.0, 0.5)))*fields.f_p->eval(5, 0, domain.voxelToWorld(vd+V2d(0.0, 0.5)))));
	M_3(16, 16) = (fields.sigma_t->eval(domain.voxelToWorld(vd+V2d(0.5, 0.0)))+
			-(fields.sigma_s->eval(domain.voxelToWorld(vd+V2d(0.5, 0.0)))*fields.f_p->eval(5, 0, domain.voxelToWorld(vd+V2d(0.5, 0.0)))));
	M_3(17, 17) = (fields.sigma_t->eval(domain.voxelToWorld(vd+V2d(0.0, 0.5)))+
			-(fields.sigma_s->eval(domain.voxelToWorld(vd+V2d(0.0, 0.5)))*fields.f_p->eval(5, 0, domain.voxelToWorld(vd+V2d(0.0, 0.5)))));
	M_3(18, 18) = (fields.sigma_t->eval(domain.voxelToWorld(vd+V2d(0.5, 0.0)))+
			-(fields.sigma_s->eval(domain.voxelToWorld(vd+V2d(0.5, 0.0)))*fields.f_p->eval(5, 0, domain.voxelToWorld(vd+V2d(0.5, 0.0)))));
	M_3(19, 19) = (fields.sigma_t->eval(domain.voxelToWorld(vd+V2d(0.0, 0.5)))+
			-(fields.sigma_s->eval(domain.voxelToWorld(vd+V2d(0.0, 0.5)))*fields.f_p->eval(5, 0, domain.voxelToWorld(vd+V2d(0.0, 0.5)))));
	M_3(20, 20) = (fields.sigma_t->eval(domain.voxelToWorld(vd+V2d(0.5, 0.0)))+
			-(fields.sigma_s->eval(domain.voxelToWorld(vd+V2d(0.5, 0.0)))*fields.f_p->eval(5, 0, domain.voxelToWorld(vd+V2d(0.5, 0.0)))));
	...
	b(15, 0) = fields.q->eval(5, -5, domain.voxelToWorld(vd+V2d(0.0, 0.5)));
	b(16, 0) = fields.q->eval(5, -3, domain.voxelToWorld(vd+V2d(0.5, 0.0)));
	b(17, 0) = fields.q->eval(5, -1, domain.voxelToWorld(vd+V2d(0.0, 0.5)));
	b(18, 0) = fields.q->eval(5, 1, domain.voxelToWorld(vd+V2d(0.5, 0.0)));
	b(19, 0) = fields.q->eval(5, 3, domain.voxelToWorld(vd+V2d(0.0, 0.5)));
	b(20, 0) = fields.q->eval(5, 5, domain.voxelToWorld(vd+V2d(0.5, 0.0)));
	Eigen::Matrix<double, 21, 1> b_real = (S*b).real();

	// Assembling global system =============
	sys.coeff_A( vi, 1, vi + V2i(-1,0), 0 ) += -(h_inv[0]*0.57735026919);
	sys.coeff_A( vi, 1, vi + V2i(0,0), 0 ) += (h_inv[0]*0.57735026919);
	sys.coeff_A( vi, 0, vi + V2i(0,0), 1 ) += -(h_inv[0]*0.57735026919);
	sys.coeff_A( vi, 0, vi + V2i(1,0), 1 ) += (h_inv[0]*0.57735026919);
	sys.coeff_A( vi, 3, vi + V2i(0,0), 1 ) += -(h_inv[0]*0.4472135955);
	sys.coeff_A( vi, 3, vi + V2i(1,0), 1 ) += (h_inv[0]*0.4472135955);
	sys.coeff_A( vi, 5, vi + V2i(0,0), 1 ) += -(h_inv[0]*-0.258198889747);
	sys.coeff_A( vi, 5, vi + V2i(1,0), 1 ) += (h_inv[0]*-0.258198889747);
	sys.coeff_A( vi, 4, vi + V2i(-1,0), 2 ) += -(h_inv[0]*0.4472135955);
	sys.coeff_A( vi, 4, vi + V2i(0,0), 2 ) += (h_inv[0]*0.4472135955);
	sys.coeff_A( vi, 1, vi + V2i(-1,0), 3 ) += -(h_inv[0]*0.4472135955);
	sys.coeff_A( vi, 1, vi + V2i(0,0), 3 ) += (h_inv[0]*0.4472135955);
	sys.coeff_A( vi, 6, vi + V2i(-1,0), 3 ) += -(h_inv[0]*0.462910049886);
	sys.coeff_A( vi, 6, vi + V2i(0,0), 3 ) += (h_inv[0]*0.462910049886);
	sys.coeff_A( vi, 8, vi + V2i(-1,0), 3 ) += -(h_inv[0]*-0.119522860933);
	sys.coeff_A( vi, 8, vi + V2i(0,0), 3 ) += (h_inv[0]*-0.119522860933);
	sys.coeff_A( vi, 2, vi + V2i(0,0), 4 ) += -(h_inv[0]*0.4472135955);
	sys.coeff_A( vi, 2, vi + V2i(1,0), 4 ) += (h_inv[0]*0.4472135955);
	sys.coeff_A( vi, 7, vi + V2i(0,0), 4 ) += -(h_inv[0]*0.462910049886);
	sys.coeff_A( vi, 7, vi + V2i(1,0), 4 ) += (h_inv[0]*0.462910049886);
	sys.coeff_A( vi, 9, vi + V2i(0,0), 4 ) += -(h_inv[0]*-0.119522860933);
	sys.coeff_A( vi, 9, vi + V2i(1,0), 4 ) += (h_inv[0]*-0.119522860933);
	sys.coeff_A( vi, 1, vi + V2i(-1,0), 5 ) += -(h_inv[0]*-0.258198889747);
	sys.coeff_A( vi, 1, vi + V2i(0,0), 5 ) += (h_inv[0]*-0.258198889747);
	sys.coeff_A( vi, 8, vi + V2i(-1,0), 5 ) += -(h_inv[0]*0.414039335605);
	sys.coeff_A( vi, 8, vi + V2i(0,0), 5 ) += (h_inv[0]*0.414039335605);
	sys.coeff_A( vi, 3, vi + V2i(0,0), 6 ) += -(h_inv[0]*0.462910049886);
	sys.coeff_A( vi, 3, vi + V2i(1,0), 6 ) += (h_inv[0]*0.462910049886);
	sys.coeff_A( vi, 10, vi + V2i(0,0), 6 ) += -(h_inv[0]*0.471404520791);
	sys.coeff_A( vi, 10, vi + V2i(1,0), 6 ) += (h_inv[0]*0.471404520791);
	sys.coeff_A( vi, 12, vi + V2i(0,0), 6 ) += -(h_inv[0]*-0.0890870806375);
	sys.coeff_A( vi, 12, vi + V2i(1,0), 6 ) += (h_inv[0]*-0.0890870806375);
	sys.coeff_A( vi, 4, vi + V2i(-1,0), 7 ) += -(h_inv[0]*0.462910049886);
	sys.coeff_A( vi, 4, vi + V2i(0,0), 7 ) += (h_inv[0]*0.462910049886);
	sys.coeff_A( vi, 11, vi + V2i(-1,0), 7 ) += -(h_inv[0]*0.471404520791);
	sys.coeff_A( vi, 11, vi + V2i(0,0), 7 ) += (h_inv[0]*0.471404520791);
	sys.coeff_A( vi, 13, vi + V2i(-1,0), 7 ) += -(h_inv[0]*-0.0890870806375);
	sys.coeff_A( vi, 13, vi + V2i(0,0), 7 ) += (h_inv[0]*-0.0890870806375);
	sys.coeff_A( vi, 3, vi + V2i(0,0), 8 ) += -(h_inv[0]*-0.119522860933);
	sys.coeff_A( vi, 3, vi + V2i(1,0), 8 ) += (h_inv[0]*-0.119522860933);
	sys.coeff_A( vi, 5, vi + V2i(0,0), 8 ) += -(h_inv[0]*0.414039335605);
	sys.coeff_A( vi, 5, vi + V2i(1,0), 8 ) += (h_inv[0]*0.414039335605);
	sys.coeff_A( vi, 12, vi + V2i(0,0), 8 ) += -(h_inv[0]*0.345032779671);
	sys.coeff_A( vi, 12, vi + V2i(1,0), 8 ) += (h_inv[0]*0.345032779671);
	sys.coeff_A( vi, 14, vi + V2i(0,0), 8 ) += -(h_inv[0]*-0.308606699924);
	sys.coeff_A( vi, 14, vi + V2i(1,0), 8 ) += (h_inv[0]*-0.308606699924);
	sys.coeff_A( vi, 4, vi + V2i(-1,0), 9 ) += -(h_inv[0]*-0.119522860933);
	sys.coeff_A( vi, 4, vi + V2i(0,0), 9 ) += (h_inv[0]*-0.119522860933);
	sys.coeff_A( vi, 13, vi + V2i(-1,0), 9 ) += -(h_inv[0]*0.345032779671);
	sys.coeff_A( vi, 13, vi + V2i(0,0), 9 ) += (h_inv[0]*0.345032779671);
	sys.coeff_A( vi, 6, vi + V2i(-1,0), 10 ) += -(h_inv[0]*0.471404520791);
	sys.coeff_A( vi, 6, vi + V2i(0,0), 10 ) += (h_inv[0]*0.471404520791);
	sys.coeff_A( vi, 15, vi + V2i(-1,0), 10 ) += -(h_inv[0]*0.476731294623);
	sys.coeff_A( vi, 15, vi + V2i(0,0), 10 ) += (h_inv[0]*0.476731294623);
	sys.coeff_A( vi, 17, vi + V2i(-1,0), 10 ) += -(h_inv[0]*-0.0710669054519);
	sys.coeff_A( vi, 17, vi + V2i(0,0), 10 ) += (h_inv[0]*-0.0710669054519);
	sys.coeff_A( vi, 7, vi + V2i(0,0), 11 ) += -(h_inv[0]*0.471404520791);
	sys.coeff_A( vi, 7, vi + V2i(1,0), 11 ) += (h_inv[0]*0.471404520791);
	sys.coeff_A( vi, 16, vi + V2i(0,0), 11 ) += -(h_inv[0]*0.476731294623);
	sys.coeff_A( vi, 16, vi + V2i(1,0), 11 ) += (h_inv[0]*0.476731294623);
	sys.coeff_A( vi, 18, vi + V2i(0,0), 11 ) += -(h_inv[0]*-0.0710669054519);
	sys.coeff_A( vi, 18, vi + V2i(1,0), 11 ) += (h_inv[0]*-0.0710669054519);
	sys.coeff_A( vi, 6, vi + V2i(-1,0), 12 ) += -(h_inv[0]*-0.0890870806375);
	sys.coeff_A( vi, 6, vi + V2i(0,0), 12 ) += (h_inv[0]*-0.0890870806375);
	sys.coeff_A( vi, 8, vi + V2i(-1,0), 12 ) += -(h_inv[0]*0.345032779671);
	sys.coeff_A( vi, 8, vi + V2i(0,0), 12 ) += (h_inv[0]*0.345032779671);
	sys.coeff_A( vi, 17, vi + V2i(-1,0), 12 ) += -(h_inv[0]*0.376050716545);
	sys.coeff_A( vi, 17, vi + V2i(0,0), 12 ) += (h_inv[0]*0.376050716545);
	sys.coeff_A( vi, 19, vi + V2i(-1,0), 12 ) += -(h_inv[0]*-0.174077655956);
	sys.coeff_A( vi, 19, vi + V2i(0,0), 12 ) += (h_inv[0]*-0.174077655956);
	sys.coeff_A( vi, 7, vi + V2i(0,0), 13 ) += -(h_inv[0]*-0.0890870806375);
	sys.coeff_A( vi, 7, vi + V2i(1,0), 13 ) += (h_inv[0]*-0.0890870806375);
	sys.coeff_A( vi, 9, vi + V2i(0,0), 13 ) += -(h_inv[0]*0.345032779671);
	sys.coeff_A( vi, 9, vi + V2i(1,0), 13 ) += (h_inv[0]*0.345032779671);
	sys.coeff_A( vi, 18, vi + V2i(0,0), 13 ) += -(h_inv[0]*0.376050716545);
	sys.coeff_A( vi, 18, vi + V2i(1,0), 13 ) += (h_inv[0]*0.376050716545);
	sys.coeff_A( vi, 20, vi + V2i(0,0), 13 ) += -(h_inv[0]*-0.174077655956);
	sys.coeff_A( vi, 20, vi + V2i(1,0), 13 ) += (h_inv[0]*-0.174077655956);
	sys.coeff_A( vi, 8, vi + V2i(-1,0), 14 ) += -(h_inv[0]*-0.308606699924);
	sys.coeff_A( vi, 8, vi + V2i(0,0), 14 ) += (h_inv[0]*-0.308606699924);
	sys.coeff_A( vi, 19, vi + V2i(-1,0), 14 ) += -(h_inv[0]*0.389249472081);
	sys.coeff_A( vi, 19, vi + V2i(0,0), 14 ) += (h_inv[0]*0.389249472081);
	sys.coeff_A( vi, 10, vi + V2i(0,0), 15 ) += -(h_inv[0]*0.476731294623);
	sys.coeff_A( vi, 10, vi + V2i(1,0), 15 ) += (h_inv[0]*0.476731294623);
	sys.coeff_A( vi, 11, vi + V2i(-1,0), 16 ) += -(h_inv[0]*0.476731294623);
	sys.coeff_A( vi, 11, vi + V2i(0,0), 16 ) += (h_inv[0]*0.476731294623);
	sys.coeff_A( vi, 10, vi + V2i(0,0), 17 ) += -(h_inv[0]*-0.0710669054519);
	sys.coeff_A( vi, 10, vi + V2i(1,0), 17 ) += (h_inv[0]*-0.0710669054519);
	sys.coeff_A( vi, 12, vi + V2i(0,0), 17 ) += -(h_inv[0]*0.376050716545);
	sys.coeff_A( vi, 12, vi + V2i(1,0), 17 ) += (h_inv[0]*0.376050716545);
	sys.coeff_A( vi, 11, vi + V2i(-1,0), 18 ) += -(h_inv[0]*-0.0710669054519);
	sys.coeff_A( vi, 11, vi + V2i(0,0), 18 ) += (h_inv[0]*-0.0710669054519);
	sys.coeff_A( vi, 13, vi + V2i(-1,0), 18 ) += -(h_inv[0]*0.376050716545);
	sys.coeff_A( vi, 13, vi + V2i(0,0), 18 ) += (h_inv[0]*0.376050716545);
	sys.coeff_A( vi, 12, vi + V2i(0,0), 19 ) += -(h_inv[0]*-0.174077655956);
	sys.coeff_A( vi, 12, vi + V2i(1,0), 19 ) += (h_inv[0]*-0.174077655956);
	sys.coeff_A( vi, 14, vi + V2i(0,0), 19 ) += -(h_inv[0]*0.389249472081);
	sys.coeff_A( vi, 14, vi + V2i(1,0), 19 ) += (h_inv[0]*0.389249472081);
	sys.coeff_A( vi, 13, vi + V2i(-1,0), 20 ) += -(h_inv[0]*-0.174077655956);
	sys.coeff_A( vi, 13, vi + V2i(0,0), 20 ) += (h_inv[0]*-0.174077655956);
	sys.coeff_A( vi, 2, vi + V2i(0,-1), 0 ) += -(h_inv[1]*0.57735026919);
	sys.coeff_A( vi, 2, vi + V2i(0,0), 0 ) += (h_inv[1]*0.57735026919);
	sys.coeff_A( vi, 4, vi + V2i(0,-1), 1 ) += -(h_inv[1]*0.4472135955);
	sys.coeff_A( vi, 4, vi + V2i(0,0), 1 ) += (h_inv[1]*0.4472135955);
	sys.coeff_A( vi, 0, vi + V2i(0,0), 2 ) += -(h_inv[1]*0.57735026919);
	sys.coeff_A( vi, 0, vi + V2i(0,1), 2 ) += (h_inv[1]*0.57735026919);
	sys.coeff_A( vi, 3, vi + V2i(0,0), 2 ) += -(h_inv[1]*-0.4472135955);
	sys.coeff_A( vi, 3, vi + V2i(0,1), 2 ) += (h_inv[1]*-0.4472135955);
	sys.coeff_A( vi, 5, vi + V2i(0,0), 2 ) += -(h_inv[1]*-0.258198889747);
	sys.coeff_A( vi, 5, vi + V2i(0,1), 2 ) += (h_inv[1]*-0.258198889747);
	sys.coeff_A( vi, 2, vi + V2i(0,-1), 3 ) += -(h_inv[1]*-0.4472135955);
	sys.coeff_A( vi, 2, vi + V2i(0,0), 3 ) += (h_inv[1]*-0.4472135955);
	sys.coeff_A( vi, 7, vi + V2i(0,-1), 3 ) += -(h_inv[1]*0.462910049886);
	sys.coeff_A( vi, 7, vi + V2i(0,0), 3 ) += (h_inv[1]*0.462910049886);
	sys.coeff_A( vi, 9, vi + V2i(0,-1), 3 ) += -(h_inv[1]*0.119522860933);
	sys.coeff_A( vi, 9, vi + V2i(0,0), 3 ) += (h_inv[1]*0.119522860933);
	sys.coeff_A( vi, 1, vi + V2i(0,0), 4 ) += -(h_inv[1]*0.4472135955);
	sys.coeff_A( vi, 1, vi + V2i(0,1), 4 ) += (h_inv[1]*0.4472135955);
	sys.coeff_A( vi, 6, vi + V2i(0,0), 4 ) += -(h_inv[1]*-0.462910049886);
	sys.coeff_A( vi, 6, vi + V2i(0,1), 4 ) += (h_inv[1]*-0.462910049886);
	sys.coeff_A( vi, 8, vi + V2i(0,0), 4 ) += -(h_inv[1]*-0.119522860933);
	sys.coeff_A( vi, 8, vi + V2i(0,1), 4 ) += (h_inv[1]*-0.119522860933);
	sys.coeff_A( vi, 2, vi + V2i(0,-1), 5 ) += -(h_inv[1]*-0.258198889747);
	sys.coeff_A( vi, 2, vi + V2i(0,0), 5 ) += (h_inv[1]*-0.258198889747);
	sys.coeff_A( vi, 9, vi + V2i(0,-1), 5 ) += -(h_inv[1]*0.414039335605);
	sys.coeff_A( vi, 9, vi + V2i(0,0), 5 ) += (h_inv[1]*0.414039335605);
	sys.coeff_A( vi, 4, vi + V2i(0,-1), 6 ) += -(h_inv[1]*-0.462910049886);
	sys.coeff_A( vi, 4, vi + V2i(0,0), 6 ) += (h_inv[1]*-0.462910049886);
	sys.coeff_A( vi, 11, vi + V2i(0,-1), 6 ) += -(h_inv[1]*0.471404520791);
	sys.coeff_A( vi, 11, vi + V2i(0,0), 6 ) += (h_inv[1]*0.471404520791);
	sys.coeff_A( vi, 13, vi + V2i(0,-1), 6 ) += -(h_inv[1]*0.0890870806375);
	sys.coeff_A( vi, 13, vi + V2i(0,0), 6 ) += (h_inv[1]*0.0890870806375);
	sys.coeff_A( vi, 3, vi + V2i(0,0), 7 ) += -(h_inv[1]*0.462910049886);
	sys.coeff_A( vi, 3, vi + V2i(0,1), 7 ) += (h_inv[1]*0.462910049886);
	sys.coeff_A( vi, 10, vi + V2i(0,0), 7 ) += -(h_inv[1]*-0.471404520791);
	sys.coeff_A( vi, 10, vi + V2i(0,1), 7 ) += (h_inv[1]*-0.471404520791);
	sys.coeff_A( vi, 12, vi + V2i(0,0), 7 ) += -(h_inv[1]*-0.0890870806375);
	sys.coeff_A( vi, 12, vi + V2i(0,1), 7 ) += (h_inv[1]*-0.0890870806375);
	sys.coeff_A( vi, 4, vi + V2i(0,-1), 8 ) += -(h_inv[1]*-0.119522860933);
	sys.coeff_A( vi, 4, vi + V2i(0,0), 8 ) += (h_inv[1]*-0.119522860933);
	sys.coeff_A( vi, 13, vi + V2i(0,-1), 8 ) += -(h_inv[1]*0.345032779671);
	sys.coeff_A( vi, 13, vi + V2i(0,0), 8 ) += (h_inv[1]*0.345032779671);
	sys.coeff_A( vi, 3, vi + V2i(0,0), 9 ) += -(h_inv[1]*0.119522860933);
	sys.coeff_A( vi, 3, vi + V2i(0,1), 9 ) += (h_inv[1]*0.119522860933);
	sys.coeff_A( vi, 5, vi + V2i(0,0), 9 ) += -(h_inv[1]*0.414039335605);
	sys.coeff_A( vi, 5, vi + V2i(0,1), 9 ) += (h_inv[1]*0.414039335605);
	sys.coeff_A( vi, 12, vi + V2i(0,0), 9 ) += -(h_inv[1]*-0.345032779671);
	sys.coeff_A( vi, 12, vi + V2i(0,1), 9 ) += (h_inv[1]*-0.345032779671);
	sys.coeff_A( vi, 14, vi + V2i(0,0), 9 ) += -(h_inv[1]*-0.308606699924);
	sys.coeff_A( vi, 14, vi + V2i(0,1), 9 ) += (h_inv[1]*-0.308606699924);
	sys.coeff_A( vi, 7, vi + V2i(0,-1), 10 ) += -(h_inv[1]*-0.471404520791);
	sys.coeff_A( vi, 7, vi + V2i(0,0), 10 ) += (h_inv[1]*-0.471404520791);
	sys.coeff_A( vi, 16, vi + V2i(0,-1), 10 ) += -(h_inv[1]*0.476731294623);
	sys.coeff_A( vi, 16, vi + V2i(0,0), 10 ) += (h_inv[1]*0.476731294623);
	sys.coeff_A( vi, 18, vi + V2i(0,-1), 10 ) += -(h_inv[1]*0.0710669054519);
	sys.coeff_A( vi, 18, vi + V2i(0,0), 10 ) += (h_inv[1]*0.0710669054519);
	sys.coeff_A( vi, 6, vi + V2i(0,0), 11 ) += -(h_inv[1]*0.471404520791);
	sys.coeff_A( vi, 6, vi + V2i(0,1), 11 ) += (h_inv[1]*0.471404520791);
	sys.coeff_A( vi, 15, vi + V2i(0,0), 11 ) += -(h_inv[1]*-0.476731294623);
	sys.coeff_A( vi, 15, vi + V2i(0,1), 11 ) += (h_inv[1]*-0.476731294623);
	sys.coeff_A( vi, 17, vi + V2i(0,0), 11 ) += -(h_inv[1]*-0.0710669054519);
	sys.coeff_A( vi, 17, vi + V2i(0,1), 11 ) += (h_inv[1]*-0.0710669054519);
	sys.coeff_A( vi, 7, vi + V2i(0,-1), 12 ) += -(h_inv[1]*-0.0890870806375);
	sys.coeff_A( vi, 7, vi + V2i(0,0), 12 ) += (h_inv[1]*-0.0890870806375);
	sys.coeff_A( vi, 9, vi + V2i(0,-1), 12 ) += -(h_inv[1]*-0.345032779671);
	sys.coeff_A( vi, 9, vi + V2i(0,0), 12 ) += (h_inv[1]*-0.345032779671);
	sys.coeff_A( vi, 18, vi + V2i(0,-1), 12 ) += -(h_inv[1]*0.376050716545);
	sys.coeff_A( vi, 18, vi + V2i(0,0), 12 ) += (h_inv[1]*0.376050716545);
	sys.coeff_A( vi, 20, vi + V2i(0,-1), 12 ) += -(h_inv[1]*0.174077655956);
	sys.coeff_A( vi, 20, vi + V2i(0,0), 12 ) += (h_inv[1]*0.174077655956);
	sys.coeff_A( vi, 6, vi + V2i(0,0), 13 ) += -(h_inv[1]*0.0890870806375);
	sys.coeff_A( vi, 6, vi + V2i(0,1), 13 ) += (h_inv[1]*0.0890870806375);
	sys.coeff_A( vi, 8, vi + V2i(0,0), 13 ) += -(h_inv[1]*0.345032779671);
	sys.coeff_A( vi, 8, vi + V2i(0,1), 13 ) += (h_inv[1]*0.345032779671);
	sys.coeff_A( vi, 17, vi + V2i(0,0), 13 ) += -(h_inv[1]*-0.376050716545);
	sys.coeff_A( vi, 17, vi + V2i(0,1), 13 ) += (h_inv[1]*-0.376050716545);
	sys.coeff_A( vi, 19, vi + V2i(0,0), 13 ) += -(h_inv[1]*-0.174077655956);
	sys.coeff_A( vi, 19, vi + V2i(0,1), 13 ) += (h_inv[1]*-0.174077655956);
	sys.coeff_A( vi, 9, vi + V2i(0,-1), 14 ) += -(h_inv[1]*-0.308606699924);
	sys.coeff_A( vi, 9, vi + V2i(0,0), 14 ) += (h_inv[1]*-0.308606699924);
	sys.coeff_A( vi, 20, vi + V2i(0,-1), 14 ) += -(h_inv[1]*0.389249472081);
	sys.coeff_A( vi, 20, vi + V2i(0,0), 14 ) += (h_inv[1]*0.389249472081);
	sys.coeff_A( vi, 11, vi + V2i(0,-1), 15 ) += -(h_inv[1]*-0.476731294623);
	sys.coeff_A( vi, 11, vi + V2i(0,0), 15 ) += (h_inv[1]*-0.476731294623);
	sys.coeff_A( vi, 10, vi + V2i(0,0), 16 ) += -(h_inv[1]*0.476731294623);
	sys.coeff_A( vi, 10, vi + V2i(0,1), 16 ) += (h_inv[1]*0.476731294623);
	sys.coeff_A( vi, 11, vi + V2i(0,-1), 17 ) += -(h_inv[1]*-0.0710669054519);
	sys.coeff_A( vi, 11, vi + V2i(0,0), 17 ) += (h_inv[1]*-0.0710669054519);
	sys.coeff_A( vi, 13, vi + V2i(0,-1), 17 ) += -(h_inv[1]*-0.376050716545);
	sys.coeff_A( vi, 13, vi + V2i(0,0), 17 ) += (h_inv[1]*-0.376050716545);
	sys.coeff_A( vi, 10, vi + V2i(0,0), 18 ) += -(h_inv[1]*0.0710669054519);
	sys.coeff_A( vi, 10, vi + V2i(0,1), 18 ) += (h_inv[1]*0.0710669054519);
	sys.coeff_A( vi, 12, vi + V2i(0,0), 18 ) += -(h_inv[1]*0.376050716545);
	sys.coeff_A( vi, 12, vi + V2i(0,1), 18 ) += (h_inv[1]*0.376050716545);
	sys.coeff_A( vi, 13, vi + V2i(0,-1), 19 ) += -(h_inv[1]*-0.174077655956);
	sys.coeff_A( vi, 13, vi + V2i(0,0), 19 ) += (h_inv[1]*-0.174077655956);
	sys.coeff_A( vi, 12, vi + V2i(0,0), 20 ) += -(h_inv[1]*0.174077655956);
	sys.coeff_A( vi, 12, vi + V2i(0,1), 20 ) += (h_inv[1]*0.174077655956);
	sys.coeff_A( vi, 14, vi + V2i(0,0), 20 ) += -(h_inv[1]*0.389249472081);
...
V2i stencil_fopn_p5_sg_get_offset(int coeff)
{
	switch(coeff)
	{
		...
		case 15:return V2i(0, 1);break;
		case 16:return V2i(1, 0);break;
		case 17:return V2i(0, 1);break;
		case 18:return V2i(1, 0);break;
		case 19:return V2i(0, 1);break;
		case 20:return V2i(1, 0);break;
