...
//				*ptr += *other_ptr*coefficient;
	...
	// the function will be called with theta € [0, pi]
	template<typename T>
...
void rasterizeSphericalFunctionMap(const std::string& filename, moexp::SphericalFunction<Color3f> func, const V2i& resolution = V2i(512, 256));
