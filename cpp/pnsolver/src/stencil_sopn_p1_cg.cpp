...
void stencil_sopn_p1_cg(PNSystem::Stencil::Context& ctx)
{
	...
	for( int i=0;i<4;++i )
	{
		...
		b(1, 0) = (-(0.408248290464*((-h_inv[0]*fields.q->eval(0, 0, domain.voxelToWorld(vd+ctx.getGridOffset2(i))))+
...
V3i stencil_sopn_p1_cg_get_offset(int coeff)
{
	switch(coeff)
	{
...
REGISTER_STENCIL(stencil_sopn_p1_cg, 1, 3, 2)
