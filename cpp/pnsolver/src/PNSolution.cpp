...
V3d PNSolution::sample( const P3d& pWS, double& pdf, RNGd& rng )
{
...
V3d PNSolution::sample( const P3d& pWS, double& pdf, const P2d& sample )
{
	P2d sample2 = sample;
	// evaluate coefficients at given world-space position
	Eigen::VectorXd coeffs = evalCoefficients(pWS);
...
{
	std::cout << "PNSolution::save: writing data to " << filename << std::endl;
